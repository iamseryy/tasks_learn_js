...
console.log("task2");
const salary = number => console.log(`Размер заработной платы за вычетом налогов равен ${number - number * .13}`);
const number = Number(prompt("Введите размер начисленной зарплаты"));
!isNaN(number) ? salary(number) : console.log("Значение задано неверно");
